# Health_Insurance_Project_ETL

This folder defines all source code for the 'Health_Insurance_Project_ETL' pipeline:
...
* Take a look at the sample under "sample_users_health_insurance_project_etl.py" to get familiar with the syntax.
